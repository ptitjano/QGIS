...
Qgs3DPointCloudEditionToolBar::Qgs3DPointCloudEditionToolBar( Qgs3DMapCanvasWidget *parent )
  : Qgs3DEditionToolBar( u"Point cloud edition"_s, parent )
{
  ...
  QAction *actionPointCloudChangeAttributeTool
    = mEditingToolsMenu->addAction( QIcon( QgsApplication::iconPath( u"mActionSelectPolygon.svg"_s ) ), tr( "Select by Polygon" ), this, &Qgs3DPointCloudEditionToolBar::changePointCloudAttributeByPolygon );
  QAction *actionPaintbrush
    = mEditingToolsMenu->addAction( QIcon( QgsApplication::iconPath( u"propertyicons/rendering.svg"_s ) ), tr( "Select by Paintbrush" ), this, &Qgs3DPointCloudEditionToolBar::changePointCloudAttributeByPaintbrush );
  QAction *actionAboveLineTool
    = mEditingToolsMenu->addAction( QIcon( QgsApplication::iconPath( u"mActionSelectAboveLine.svg"_s ) ), tr( "Select Above Line" ), this, &Qgs3DPointCloudEditionToolBar::changePointCloudAttributeByAboveLine );
  QAction *actionBelowLineTool
    = mEditingToolsMenu->addAction( QIcon( QgsApplication::iconPath( u"mActionSelectBelowLine.svg"_s ) ), tr( "Select Below Line" ), this, &Qgs3DPointCloudEditionToolBar::changePointCloudAttributeByBelowLine );
  ...
  QAction *actionPointFilter
    = addAction( QIcon( QgsApplication::iconPath( "mIconExpressionFilter.svg" ) ), tr( "Filter Points" ), this, &Qgs3DPointCloudEditionToolBar::changePointCloudAttributePointFilter );
