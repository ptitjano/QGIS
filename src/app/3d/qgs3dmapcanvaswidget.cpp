  ...
  , mCanvasName( name )
{
  ...
  mEditingToolBar->addWidget( new Qgs3DPrimitiveEditionToolBar( this ) );
...
void Qgs3DMapCanvasWidget::updateEditionToolBar()
{
  ...
  else
  {
    ...
    if ( mCanvas->mapTool() && mCanvas->mapTool() == mPointCloudEditingToolbar->tool() )
      mCanvas->setMapTool( nullptr );
  }
}
